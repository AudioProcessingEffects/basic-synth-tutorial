...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1351.083333333333485, 138.5, 83.833333333333258, 94.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1287.791666666666742, 165.5, 63.0, 67.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 407.699999999999989, 484.0, 205.263157367706299, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 643.0, 87.0, 34.0 ],
					"text" : "FILTER SECTION",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1069.0, 362.0, 92.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1465.0, 291.0, 219.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1603.0, 192.0, 87.0, 34.0 ],
					"text" : "ADSR OPTION 2",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 614.263157367706299, 510.0, 102.0, 20.0 ],
					"text" : "ADSR OPTION 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 614.263157367706299, 479.0, 102.0, 20.0 ],
					"text" : "ADSR OPTION 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 718.263157367706299, 509.0, 29.5, 22.0 ],
					"text" : "2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 718.263157367706299, 478.0, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 1321.333333333333258, 402.5, 34.0, 22.0 ],
					"text" : "line~"
				}
...
, 			{
				"box" : 				{
					"addpoints" : [ 0.0, 0.0, 0, 303.191489361702111, 0.533333333333333, 0, 824.468085106383, 0.746666666666667, 0, 1000.0, 0.0, 0 ],
					"classic_curve" : 1,
					"id" : "obj-25",
					"maxclass" : "function",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1074.0, 192.0, 87.0, 34.0 ],
					"text" : "ADSR OPTION 1",
					"textjustification" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 217.0, 191.5, 87.0, 34.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 858.0, 431.0, 217.105262517929077, 53.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 460.5, 687.0, 205.263157367706299, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 7.0, 337.0, 205.263157367706299, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 511.0, 68.894737560966519, 205.263157367706299, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 796.0, 220.5, 219.0, 52.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 471.789473652839661, 190.0, 163.0, 38.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 522.899999999999977, 352.0, 40.0, 22.0 ],
					"text" : "tri~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 465.300000000000011, 352.0, 40.0, 22.0 ],
					"text" : "rect~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 407.699999999999989, 352.0, 37.0, 22.0 ],
					"text" : "saw~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 350.100000000000023, 352.0, 43.0, 22.0 ],
					"text" : "cycle~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 778.0, 109.5, 198.0, 66.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.200000000000045, 182.0, 437.799999999999955, 262.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 208.200000000000045, 637.0, 475.0, 106.0 ],
					"proportion" : 0.5
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1330.833333333333258, 534.0, 785.0, 534.0 ],
					"source" : [ "obj-31", 0 ]
				}
